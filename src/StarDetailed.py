...
class StarDetailedInfo(QMainWindow):
    ...
    def initUI(self):
        ...
        self.picUrl = 'pic/starring/large/' + self.info['PicName']
        ...
        self.starWidget = QWidget()
        self.starWidget.setLayout(self.wholeLayout)
        self.setContentsMargins(10, 0, 10, 10)
        self.setCentralWidget(self.starWidget)
