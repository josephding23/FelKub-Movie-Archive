...
from src.RecommenderPage import RecommenderPage
from src import DirectorDetailed, StarDetailed, MoviesPage
from src.TraitsEdit import MovieTraitsEditPage
from src.DataQuery import get_movies_of_genre, get_movies_with_related_tags_and_genres, \
    get_movies_with_related_casts, get_movies_directed_by, get_movies_starred_by, \
