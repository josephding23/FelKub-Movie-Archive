from PyQt5.QtWidgets import QMainWindow, QDesktopWidget, QWidget, QFrame, QVBoxLayout, QHBoxLayout, QPushButton, QLabel
from PyQt5.QtGui import QPixmap, QFont, QIcon, QCursor
from PyQt5.QtCore import Qt, QSize
from DataQuery import *
from math import ceil
import MovieDetailed
...
class RecommenderPage(QMainWindow):
    ...
    def initUI(self):
        ...
        self.recommenderLayout.addWidget(QLabel('包含相同导演和演员的电影: '), 2)
        long_describes = list()
